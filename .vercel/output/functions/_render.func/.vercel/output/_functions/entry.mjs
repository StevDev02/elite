...
const _page3 = () => import('./pages/api/signin.astro.mjs');
...
const pageMap = new Map([
    ["node_modules/.pnpm/astro@4.11.0_@types+node@20.14.7_typescript@5.5.2/node_modules/astro/dist/assets/endpoint/generic.js", _page0],
    ["src/pages/api/auth/register.ts", _page1],
    ["src/pages/api/auth/signout.ts", _page2],
    ["src/pages/api/signin.ts", _page3],
...
const _args = {
    "middlewareSecret": "a5d9ca0a-bda4-402f-b157-85c1a5f33a87",
